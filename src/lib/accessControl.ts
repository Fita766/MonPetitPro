...
export const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  group('observations', 'Observations', [
    ...
    ['observations.view_assigned', 'Voir ses observations affectées', 'Voir uniquement les points dont la personne est responsable.'],
    ['observations.view_all', 'Voir toutes les observations', 'Voir les points de toutes les personnes, y compris ceux sans affectation.'],
    ...
    ['observations.edit_assigned', 'Modifier ses points affectés', 'Modifier le contenu et la résolution proposée des points qui lui sont confiés.'],
    ['observations.edit_all', 'Modifier toutes les observations', 'Modifier les points de tous les auteurs.'],
    ['observations.assign', 'Affecter à la création', 'Choisir la personne responsable lors de la création.'],
    ['observations.reassign', 'Réaffecter un point', 'Changer la personne responsable après la création.'],
    ['observations.set_completion', 'Renseigner la réalisation', 'Modifier la date de réalisation effective.'],
    ['observations.set_status', 'Modifier le statut', 'Choisir En cours, Réussi, Échec ou Bloqué.'],
    ['observations.validate', 'Valider les résolutions', 'Confirmer qu’une résolution est acceptée.'],
    ['observations.set_dg', 'Marquer un point DG', 'Ajouter ou retirer la confidentialité Direction générale.'],
