  ...
  return (
    <div className="flex items-center justify-end gap-1">
      {observation.resolution_validated_at ? (
        <span title={`Validée le ${new Date(observation.resolution_validated_at).toLocaleString('fr-FR')}`} className="inline-flex items-center gap-1 rounded-full bg-emerald-50 px-2 py-1 text-[10px] font-medium text-emerald-700"><BadgeCheck size={13} /> Validée</span>
