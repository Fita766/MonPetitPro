    ...
    <div className="pb-12">
      ...
      <div className="bg-white p-6 rounded-xl border border-slate-200 mb-8 shadow-sm">
        <div className="flex flex-col sm:flex-row justify-between items-start mb-6 gap-4">
          <div>
            ...
            <p className="text-slate-600 flex items-center gap-2">
              ...
              Conducteur : <span className="font-medium">{operation.project_manager}</span>
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t border-slate-100">
          ...
          <div>
            <p className="text-sm text-slate-500 mb-1">Nombre de logements</p>
            <p className="font-medium text-slate-800">{operation.total_housing_units || 0}</p>
          </div>
          <div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200">
                  ...
                  <th className="p-4 font-medium text-slate-600 text-sm">Responsable</th>
